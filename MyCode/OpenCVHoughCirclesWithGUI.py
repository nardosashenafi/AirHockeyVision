...
videoCapture.set(cv.CAP_PROP_AUTO_EXPOSURE, autoExposure)	# Set camera auto exposure off
videoCapture.set(cv.CAP_PROP_AUTOFOCUS, autoFocus)			# Set camera auto focus on
...
def createGUI():
	...
	def setBlurLevel(value):
		global blurLevel
		blurLevel = int(value)
		blurLevel_label_value.configure(text=int(value))
	...
	def setAutoExposure(value):
		...
		cameraAutoExposure_label_value.configure(text=int(value))
	...
	def setAutoFocus(value):
		...
		cameraAutoFocus_label_value.configure(text=int(value))

	## Sliders for circle detecting algorithm
	# Blur level of frame
	blurLevel_label = customtkinter.CTkLabel(master=algorithmFrame, text="Blur", font=('Arial', 22))
	blurLevel_label.grid(row=0, column=0, pady=10, padx=10)
	blurLevel_slider = customtkinter.CTkSlider(master=algorithmFrame, from_=1, to=55, width=400, number_of_steps=27, border_width=3, command=setBlurLevel)
	blurLevel_slider.set(blurLevel)
	blurLevel_slider.grid(row=0, column=1, pady=10, padx=10)
	blurLevel_label_value = customtkinter.CTkLabel(master=algorithmFrame, text=blurLevel, font=('Arial', 22))
	...
	dp_slider = customtkinter.CTkSlider(master=algorithmFrame, from_=1, to=5, width=400, number_of_steps=80, border_width=3, command=setDp)
	dp_slider.set(dp)
	...
	minDist_slider = customtkinter.CTkSlider(master=algorithmFrame, from_=1, to=100, width=400, number_of_steps=999, border_width=3, command=setMinDist)
	...
	minRadius_slider = customtkinter.CTkSlider(master=algorithmFrame, from_=1, to=200, width=400, number_of_steps=199, border_width=3, command=setMinRadius)
	...
	maxRadius_slider = customtkinter.CTkSlider(master=algorithmFrame, from_=1, to=400, width=400, number_of_steps=399, border_width=3, command=setMaxRadius)
	...
	circleSensitivity_slider = customtkinter.CTkSlider(master=algorithmFrame, from_=1, to=200, width=400, number_of_steps=199, border_width=3, command=setCircleSensitivity)
	...
	circleEdgePoints_slider = customtkinter.CTkSlider(master=algorithmFrame, from_=4, to=100, width=400, number_of_steps=96, border_width=3, command=setCircleEdgePoints)
	...
	cameraBrightness_slider = customtkinter.CTkSlider(master=cameraFrame, from_=0, to=255, width=400, number_of_steps=255, border_width=3, command=setBrightness)
	...
	cameraContrast_slider = customtkinter.CTkSlider(master=cameraFrame, from_=0, to=255, width=400, number_of_steps=255, border_width=3, command=setContrast)
	...
	cameraSaturation_slider = customtkinter.CTkSlider(master=cameraFrame, from_=0, to=255, width=400, number_of_steps=255, border_width=3, command=setSaturation)
	...
	cameraHue_slider = customtkinter.CTkSlider(master=cameraFrame, from_=0, to=255, width=400, number_of_steps=255, border_width=3, command=setHue)
	...
	cameraGain_slider = customtkinter.CTkSlider(master=cameraFrame, from_=0, to=255, width=400, number_of_steps=255, border_width=3, command=setGain)
	...
	cameraExposure_slider = customtkinter.CTkSlider(master=cameraFrame, from_=0, to=255, width=400, number_of_steps=255, border_width=3, command=setExposure)
	...
	cameraExposure_label = customtkinter.CTkLabel(master=cameraFrame, text="Camera Auto Exposure", font=('Arial', 22))
	cameraExposure_label.grid(row=6, column=3, pady=10, padx=10)
	cameraExposure_slider = customtkinter.CTkSlider(master=cameraFrame, from_=0, to=1, width=400, number_of_steps=1, border_width=3, command=setAutoExposure)
	cameraExposure_slider.set(autoExposure)
	cameraExposure_slider.grid(row=6, column=4, pady=10, padx=10)
	cameraAutoExposure_label_value = customtkinter.CTkLabel(master=cameraFrame, text=autoExposure, font=('Arial', 22))
	cameraAutoExposure_label_value.grid(row=6, column=5, pady=10, padx=10)

	# Auto Focus of capture
	cameraExposure_label = customtkinter.CTkLabel(master=cameraFrame, text="Camera Auto Focus", font=('Arial', 22))
	cameraExposure_label.grid(row=7, column=3, pady=10, padx=10)
	cameraExposure_slider = customtkinter.CTkSlider(master=cameraFrame, from_=0, to=1, width=400, number_of_steps=1, border_width=3, command=setAutoFocus)
	cameraExposure_slider.set(autoFocus)
	cameraExposure_slider.grid(row=7, column=4, pady=10, padx=10)
	cameraAutoFocus_label_value = customtkinter.CTkLabel(master=cameraFrame, text=autoFocus, font=('Arial', 22))
